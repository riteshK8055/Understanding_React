      ...
      >
        <div className="col-span-2 ">
          <div className="space-y-4 ">
            ...
            <p className="font-bold text-white">Call Us :<span className="text-yellow-500">(+91) 7224968932</span></p>

            <p className="mt-4 text-white">
              Travelling , Nature , Love  <br /> <br />
              ritesh@evergreenescape.com
            </p>
          </div>
        </div>
        ...
        <div className="col-span-1 sm:col-span-1">
         ...
         <div className="col-span-3 sm:col-span-1">
          <p className="font-medium text-white">Stay Up Newsletter</p>
                    ...
                    <span className="text-sm font-light text-gray-400">@2024  AllRights Reserved</span>
