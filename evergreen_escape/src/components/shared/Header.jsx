import { useState } from "react";
 import avatar from '../../assets/images/kisspng-computer-icons-avatar-encapsulated-postscript-tomato-face-5ae78e3c71e6a4.0699443615251246684666.jpg'
      ...
      <div className="justify-between px-4 mx-auto lg:max-w-7xl md:items-center md:flex md:px-8">
        ...
        <div>
          ...
          >
            <ul className="items-center justify-center space-y-8 md:flex md:space-x-6 md:space-y-0">
              <li className="text-black font-bold hover:text-blue-300 shadow-xl rounded-lg p-2">
                <Link to="/">Home</Link>
              </li>
              <li className="text-black font-bold hover:text-blue-300 shadow-xl rounded-lg p-2">
        ...
        <div className="hidden space-x-2 md:inline-block ">
          {user ? (
            ...
            <Link to="/login" className="px-4 py-2 text-white font-bold border border-transparent bg-blue-700 hover:bg-blue-500  shadow-lg rounded-md  ">
              Log in
            </Link>
          )}
        </div>
